...
Public Class FormPrincipalSecre
...
#Region "FORMS"
    ...
    Private Sub btnPacinte_Click_1(sender As Object, e As EventArgs) Handles btnPaciente.Click
        AbrirFormEnPanel(Of PacientesSecre)()
    ...
    Private Sub btnEmpleados_Click_1(sender As Object, e As EventArgs) Handles btnEmpleados.Click
        AbrirFormEnPanel(Of FormProfesionalesSecre)()
        'btnEmpleados.BackColor = Color.SpringGreen
    End Sub

    Private Sub btnTurnos_Click_1(sender As Object, e As EventArgs) Handles btnTurnos.Click
        AbrirFormEnPanel(Of TablaTurnos1)()
        'btnTurnos.BackColor = Color.SpringGreen
    End Sub

    Private Sub btnAgenda_Click(sender As Object, e As EventArgs) Handles btnAgenda.Click
        AbrirFormEnPanel(Of FormAgendaSecre)()
    ...
    End Sub
    Sub cargarNombre()
        lbOnline.Text = "Sesión: " + LogginForm.txtUsuario.Text + "(secre)"
    End Sub
