...
#Region "Botones bajos"
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Else
            Try
                ClaseDatos.actualizarGenero(TablaGenero.DataGridView1.CurrentRow.Cells("Id").Value, txtNombre.Text)
                txtNombre.Text = ""
                txtDesc.Text = ""
    ...
    Private Sub EditGenero_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim os As Genero = ClaseDatos.getInfoGeneros(TablaGenero.DataGridView1.CurrentRow.Cells("Id").Value)
            With os
