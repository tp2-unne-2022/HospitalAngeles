...
#Region "RESTRICCIONES"
    ...
    Private Sub txtDesc_TextChanged(sender As Object, e As KeyPressEventArgs)
...
#Region "Botones bajos"
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Else
            Try
                ClaseDatos.actualizarTipoPersonal(TipoPersonal.DataGridView1.CurrentRow.Cells("Id").Value, txtNombre.Text)
                txtNombre.Text = ""
                TipoPersonal.cargarListadoTipoPersonal()
    ...
    Private Sub EditGenero_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim os As Tipo_Personal = ClaseDatos.getInfoTipoPersonal(TipoPersonal.DataGridView1.CurrentRow.Cells("Id").Value)
            With os
                txtNombre.Text = .nombre
            End With
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error al seleccionar registro", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
#End Region
End Class