...
#End Region
    ...
    End Sub
    Private Sub Cargar()
        Dim MiReporte As New CRObraSocialPersonal
        MiReporte.SetParameterValue("@Inicial", Me.dtpDesde.Value.Date)
        MiReporte.SetParameterValue("@Final", Me.dtpHasta.Value.Date)
        'MiReporte.DataSourceConnections.Item(0).SetLogonProperties("(local)",-contraseña-)
        Me.crvOS.ReportSource = MiReporte
    End Sub
