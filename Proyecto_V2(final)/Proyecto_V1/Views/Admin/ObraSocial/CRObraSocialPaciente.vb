...
Public Class CRObraSocialPaciente
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRObraSocialPaciente.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Proyecto_V1.CRObraSocialPaciente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRObraSocialPaciente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRObraSocialPaciente = New CRObraSocialPaciente()
        rpt.Site = Me.Site
        Return rpt
    End Function
