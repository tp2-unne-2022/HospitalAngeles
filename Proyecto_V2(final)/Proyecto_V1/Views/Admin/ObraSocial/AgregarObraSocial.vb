...
Public Class AgregarObraSocial
#Region "BOTONES - X"
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        Else
            Try
                ...
                valorDeBaja = True
                contarFilas = FormOS.DataGridView1.Rows.Count + 1
                ClaseDatos.insertarObraSocial(New Obra_Social() With {.Id = contarFilas, .nombre = txtNombre.Text, .porc_cobertura = txtCobertura.Text, .deBaja = valorDeBaja})
                txtNombre.Text = ""
                txtCobertura.Text = ""
                FormOS.cargarListadoObraSocial()
